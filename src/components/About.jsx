            ...
            <div className='p-5 md:p-10 bg-gray-950 rounded-md shadow-[0px_0px_20px_10px_rgba(0,0,0,0.3)] shadow-blue-500'>
                ...
                <div className='mt-5'>
                    ...
                    <div className='flex flex-wrap gap-4 mb-5 text-sm'>
                        ...
                        <p className='bg-gray-900 cursor-pointer text-gray-300 px-2 py-1 rounded-full hover:shadow-xl transition-transform transform hover:-translate-y-2'>Python</p>
                        ...
                        <p className='bg-gray-900 cursor-pointer text-gray-300 px-2 py-1 rounded-full hover:shadow-xl transition-transform transform hover:-translate-y-2'>Node.js</p>
                        <p className='bg-gray-900 cursor-pointer text-gray-300 px-2 py-1 rounded-full hover:shadow-xl transition-transform transform hover:-translate-y-2'>Firestore</p>
                        <p className='bg-gray-900 cursor-pointer text-gray-300 px-2 py-1 rounded-full hover:shadow-xl transition-transform transform hover:-translate-y-2'>Firebase</p>
