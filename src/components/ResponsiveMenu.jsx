        ...
        <div>
            ...
            <nav className='mt-12'>
                <ul className='flex flex-col gap-7 text-lg font-semibold text-white'>
                    ...
                    <a href="#experience"><li className='cursor-pointer' onClick={()=>setShowMenu(false)}>Experience</li></a>
                    <a href="#skill"><li className='cursor-pointer' onClick={()=>setShowMenu(false)}>Skills</li></a>
